...
const USDC_WETH_PAIR = '0xD776C65B2A7a5832b4172742BF8C40CC062C678E'
const DAI_WETH_PAIR = '0x6309D302d00fE6Da92e63092693F670274077b19'
const USDT_WETH_PAIR = '0x75992E8266Ab600d4e9B0D7471dB6ba0D75b44b8'
...
let WHITELIST: string[] = [  
  ...
  "0xC168E40227E4ebD8C1caE80F7a55a4F0e6D66C97", // DFYN Token (PoS)
  "0xa3Fa99A148fA48D14Ed51d610c367C61876997F1", // miMATIC
  '0x45c32fA6DF82ead1e2EF74d17b76547EDdFaFF89', // FRAX
  '0x996C1f2d0ccc2B2249F59057933486cA2fdcB1B4', // MKR
  '0x8505b9d2254A7Ae468c0E9dd10Ccea3A837aef5c', // COMP
  '0xCe9D1CfF98be0AaA06843B43145a404fC0DFC463', // LINK
  "0x385Eeac5cB85A38A9a07A70c73e0a3271CfB54A7", // Aavegotchi GHST Token (PoS)
]
...
export function getTrackedVolumeUSD(
  ...
  let price0 = new BigDecimal(BigInt.fromI32(0))
  let price1 = new BigDecimal(BigInt.fromI32(0))
  let derivedETH0 = token0.derivedETH
  let derivedETH1 = token1.derivedETH
  if (bundle && derivedETH0 && derivedETH1) {
    price0 = derivedETH0.times(bundle.ethPrice)
    price1 = derivedETH1.times(bundle.ethPrice)
  }
